        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 text-xs font-bold rounded-xl transition-all border ${
              shareCopied
                ...
                : 'bg-white/60 border-slate-200/50 text-slate-600 hover:bg-white shadow-sm backdrop-blur-md'
            }`}
          ...
          >
            {shareCopied ? (
              ...
              <>
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13.828 10.172a4 4 0 010 5.656l-3 3a4 4 0 11-5.656-5.656l1.172-1.172m7.172-1.172l1.172-1.172a4 4 0 015.656 5.656l-3 3a4 4 0 01-5.656 0"/></svg>
                SHARE LINK
              </>
            )}
          </button>
